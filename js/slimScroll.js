  ...
  jQuery.fn.extend({
    slimScroll: function(options) {
      ...
      var isOverPanel, isOverBar, isDragg, queueHide, barHeight, percentScroll,
        ...
        scroll = o.scroll,
        zindex = o.zindex;	//fix for selectbox
        ...
        var wrapper = $(divS)
          ...
          .css({
            ...
            width: cwidth,
            height: cheight,
            top: me.css("top")+"!important" //fix for selectbox
          });

        // update style for the div
        me.css({
          overflow: 'hidden',
          //width: cwidth,    //FOR NO OVERLAP
          height: cheight,
          top: "0px"	//fix for selectbox
        });
